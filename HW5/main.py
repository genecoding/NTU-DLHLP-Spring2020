...
if __name__ == '__main__':
    ...
    parser.add_argument("-log_steps", help="log every [log_steps] steps", default=5 , type=int)
    ...
    parser.add_argument('--acc_file', help='the acc file used for evaluator', default='acc_yelp.bin', type=str)
    parser.add_argument('--ppl_file', help='the ppl file used for evaluator', default='ppl_yelp.binary', type=str)
