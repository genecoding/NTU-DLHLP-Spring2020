...
file = yaml.load(open('example/config/ctb/pad_ctb-BERTbase.yaml'), Loader=yaml.FullLoader)
...
if args.task_name == 'parse-depth':
    ...
    file['probe_training']['loss'] = 'L1'
elif args.task_name == 'parse-depth-rankloss':
    file['probe']['task_signature'] = 'word'
    file['reporting']['reporting_methods'] = ['spearmanr', 'root_acc']
    file['probe_training']['loss'] = 'Rank'
else:
