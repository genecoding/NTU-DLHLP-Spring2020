...
if [ -z ${tag} ]; then
  expdir=exp/train_3-2_r${sample_rate}_N${N}_L${L}_B${B}_H${H}_P${P}_X${X}_R${R}_C${C}_${norm_type}_causal${causal}_${mask_nonlinear}_epoch${epochs}_half${half_lr}_norm${max_norm}_bs${batch_size}_worker${num_workers}_pit${pit}_${optimizer}_lr${lr}_mmt${momentum}_l2${l2}_`basename $train_dir`
else
